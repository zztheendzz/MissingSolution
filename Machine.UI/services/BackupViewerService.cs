                        ...
                        try
                        {
                                       ...
                                       $"Data Source={dbPath};Version=3;"))
                            {
                                ...
                                foreach (var g in grouped)
                                {
                                    ...
                                    ws.Cell(r, startCol + 0)
                                      .Value = "STT";

                                    ws.Cell(r, startCol + 1)
                                      .Value = "Date";

                                    ws.Cell(r, startCol + 2)
                                      .Value = "Time";

                                    ws.Cell(r, startCol + 3)
                                      .Value = "TrayName";

                                    ws.Cell(r, startCol + 4)
                                      .Value = "TrayId";

                                    ws.Cell(r, startCol + 5)
                                      .Value = "ProductId";

                                    ws.Cell(r, startCol + 6)
                                      .Value = "Row";

                                    ws.Cell(r, startCol + 7)
                                      .Value = "Col";

                                    ws.Cell(r, startCol + 8)
                                      .Value = "Result";
